document.addEventListener("DOMContentLoaded", () => {
    ...
    function connect() {
        ...
        stompClient.connect({}, function (frame) {
            console.log('Conectado a STOMP (ROT5): ' + frame);
            stompClient.subscribe('/topic/rot5', function (response) {
                ...
                if(data.error) {
                    ...
                    outputTexto.value = "";
                    outputTexto.classList.replace('text-amber-300', 'text-red-400');
                } else {
                    outputTexto.value = data.resultado;
                    outputTexto.classList.replace('text-red-400', 'text-amber-300');
                }
            });
        }, function(error) {
    ...
    function enviarDatos() {
        ...
        // ROT5 es tan simple que solo mandamos el texto
